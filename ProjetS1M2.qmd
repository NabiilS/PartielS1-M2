...
Pour notre mini projet d'analyse des salaires, nous avons besoin des packages ci dessous: 
- dplyr 
- ggplot2 
- compareGroups 
- car 
...
## Regression catégoriel

## Y(salaire)=b0 + b1*sex + b2*race + b3*native_country + b4*age
